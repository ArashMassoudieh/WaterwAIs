...
#if !defined(Q_OS_WASM) && defined(USE_TEST_DATA)
    // Directing to use Test data
    host_path.replace(QStringLiteral("Data"), QStringLiteral("TestData"));
#endif
...
#else
    return QUrl("http://localhost:30000/WaterwAIs.html");
#endif
}
